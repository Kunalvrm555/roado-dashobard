    ...
    <Box bgcolor="background.default" p={2}>
      ...
      <TableContainer component={Paper} elevation={0} sx={{ border: 0.5, borderColor: 'grey.500', borderRadius: '5px' }}>
        <Table aria-label="completed activities table">
          <TableBody>
            ...
            <TableRow>
              <TableCell sx={{ color: '#6E6E73' }}>Aman (Driver) Picked Up goods at Location_Name for Load No. I-I-AAA-1325</TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{ color: '#6E6E73' }}>Gurpreet Singh (Dispatch team) has created Load No. I-I-AAA-1325</TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{ color: '#6E6E73' }}>Load No. I-I-AAA-1325 will start added by Gurpreet Singh</TableCell>
            </TableRow>
          </TableBody>
        </Table>
      </TableContainer>
      ...
      <TableContainer component={Paper} elevation={0} sx={{ border: 0.5, borderColor: 'grey.500', borderRadius: '5px' }}>
        <Table aria-label="scheduled activities table">
          <TableBody>
            <TableRow>
              <TableCell sx={{ color: '#6E6E73' }}>Load No. I-I-AAA-1325 will be delivered by Aman (Driver)</TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{ color: '#6E6E73' }}>Aman (Driver) will Picked Up goods at Location_Name for Load No. I-I-AAA-1325</TableCell>
            </TableRow>
            <TableRow>
              <TableCell sx={{ color: '#6E6E73' }}>Load No. I-I-AAA-1325 will start added by Gurpreet Singh</TableCell>
            </TableRow>
